...
const skillCategories = [
  ...
  },
  {
    ...
    skills: ['MySQL', 'Google Colab', 'VS Code', 'Jupyter Notebook', 'IoT Systems', 'Photoshop'],
  },
  {
    title: 'Data Skills',
    skills: ['Data Cleaning', 'Data Visualization', 'Statistical Analysis', 'Predictive Modeling', 'Machine Learning'],
  },
];
