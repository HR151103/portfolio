...
export const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await fetch("https://formsubmit.co/ajax/hrithik.a.r151103@gmail.com", {
        method: "POST",
        headers: {
          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">hrithik.a.r151103@gmail.com</p>
                </div>
              </a>

              <a
                href="tel:+918072916717"
                className="flex items-center gap-4 glass-card p-4 hover:border-primary/30 transition-all duration-300 group"
              >
                <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                ...
                <div>
                  ...
                  <p className="font-medium group-hover:text-primary transition-colors">+91 80729 16717</p>
                </div>
              </a>
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-3">
                <a href="https://www.linkedin.com/in/hrithik-a-ar-d47785247" target="_blank" rel="noopener noreferrer" className="social-icon">
                  <Linkedin size={20} />
                </a>
